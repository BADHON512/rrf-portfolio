...
const Blog = (props: Props) => {
  return (
    ...
    <div className="w-full flex justify-between">
      {/* Card 1 */}
      <div className="flex flex-col items-center gap-8 bg-white shadow-md w-[336px] h-[426px]">
        ...
        <div className="p-4 text-left">
          ...
          <h2 className="text-lg font-bold text-gray-900">Typography Tips for Design Success</h2>
          ...
          <div className="inline-flex items-center gap-2 relative flex-[0_0_auto]">
              <div className="inline-flex items-center gap-8 relative flex-[0_0_auto]">
                <div className="relative w-fit mt-[-1.00px] font-text-xs-font-bold font-[number:var(--text-xs-font-bold-font-weight)] text-dark text-[length:var(--text-xs-font-bold-font-size)] text-center tracking-[var(--text-xs-font-bold-letter-spacing)] leading-[var(--text-xs-font-bold-line-height)] whitespace-nowrap [font-style:var(--text-xs-font-bold-font-style)]">
                  Read More
                </div>
              </div>
      ...
      <div className="flex flex-col items-center gap-8 bg-white shadow-md w-[336px] h-[426px]">
        ...
        <div className="p-4 text-left">
          <p className="text-xs text-gray-600">August 15, 2023 / UX</p>
          <h2 className="text-lg font-bold text-gray-900">Color Psychology in UX</h2>
          <p className="text-sm text-gray-700">
      ...
      <div className="flex flex-col items-center gap-8 bg-white shadow-md w-[336px] h-[426px]">
        ...
        <div className="p-4 text-left">
          <p className="text-xs text-gray-600">August 15, 2023 / UX</p>
          <h2 className="text-lg font-bold text-gray-900">Boosting UX with Microinteractions</h2>
          <p className="text-sm text-gray-700">
